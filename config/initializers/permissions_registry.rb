...
BASE_PERMISSIONS = {
  ...
  manage_impact: {
    ...
    account_considerations: [
      { title: -> { I18n.t("Impact") },
        description: -> { I18n.t("Impact is an add-on to Genz Cyber Academy. Contact your CSM if interested.") } }
    ]
  },
  access_oak: {
    ...
    details: [
      { title: -> { I18n.t("IgniteAI Agent - Admins") },
        description: -> { I18n.t("Allows user to access the IgniteAI Agent for Genz Cyber Academy.") } }
    ],
    considerations: [
      { title: -> { I18n.t("IgniteAI Agent - Admins") },
